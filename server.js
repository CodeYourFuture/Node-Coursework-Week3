...
app.post("/bookings", (req, res) => {
  ...
  if (
    ...
    res.status(200).json({ msg: "Success! New booking wasadded" });
  }
...
app.delete("/bookings/:id", (req, res) => {
  ...
  if (index < 0) {
    res
      .status(404)
      .json({ msg: `No booking with id ${req.params.id} is found` });
  }

  bookings.splice(index, 1);
  res.status(200).json({ msg: `Booking with id ${req.params.id} is deleted` });
});
